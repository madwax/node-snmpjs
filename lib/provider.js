...
/// RHC to look at __defineGetter__ are old hat!

function
ProviderRequest( communityIs, op, addr, node, iterate )
{
	var self = this;
	this._op = op;
	...
	this.__defineGetter__('community', function () { return (self._community); });
